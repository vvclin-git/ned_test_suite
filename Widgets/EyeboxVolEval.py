...
class EyeboxVolEval(Frame):
    def __init__(self, window):
        ...
        self.draper_paras_tab = ParameterTab(self.draper_frame, draper_paras)
        ...
        self.eyebox_view_paras_tab = ParameterTab(self.eyebox_view_frame, eyebox_view_paras)
    ...
    def eyebox_eval(self):
        self.pupil_aper_pts = self.controller.near_mesh_process.border_coords
    ...
    def draw_eyebox_vol(self):
        self.proj_plane_grid, self.view, self.aper_depth_grid  = self.eyebox_view_paras_tab.output_parsed_vals()
