...
class Distortion(NetsFrame):
    def __init__(self, window):
        ...
        output_browse_btn = Button(self.analysis_preset_frame, text='Browse...', style='Buttons.TButton', command=self.file_browse)
        output_browse_btn.grid(row=1, column=0, sticky='E', padx=0, pady=5)
        output_load_btn = Button(self.analysis_preset_frame, text='Load...', style='Buttons.TButton', command=self.load_preset)
        output_load_btn.grid(row=1, column=1, sticky='E', padx=0, pady=5)
        output_save_btn = Button(self.analysis_preset_frame, text='Save As...', style='Buttons.TButton', command=self.save_preset)        
        ...
        self.img_load_frame.columnconfigure(0, weight=5, uniform=1)
        ...
        # self.img_path_input.grid(row=0, column=0, columnspan=3, sticky='EW', ipady=5)
        self.img_path_input.pack(side='left', expand=True, fill='x')

        img_browse_btn = Button(self.img_load_frame, text='Browse...', style='Buttons.TButton', command=self.file_browse)
        # img_browse_btn.grid(row=1, column=0, sticky='E', padx=0, pady=5)
        ...
        self.dist_grid_settings.pack(side='top')
        ...
        self.grid_extract_settings.pack()
